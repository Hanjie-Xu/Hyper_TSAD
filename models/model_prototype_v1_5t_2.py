...
class HypergraphEncoderTransformerNormOnly(nn.Module):
    """Hypergraph transformer encoder with LayerNorm only, no outer ReLU or residual."""
...
class ModelPrototypeV15T2(nn.Module):
    """Model v1.5t.2: causal-conv temporal encoder + hypergraph transformer, no outer ReLU/residual."""
    ...
    def __init__(
        ...
        self.hypergraph_encoder = HypergraphEncoderTransformerNormOnly(
            hidden_dim=hidden_dim,
...
ModelPrototype = ModelPrototypeV15T2
