...
class HypergraphEncoderTransformer(nn.Module):
    """Hypergraph transformer encoder with residual connection."""
...
class ModelPrototypeV15T(nn.Module):
    """Model v1.5t: causal-conv temporal encoder + hypergraph transformer."""
    ...
    def __init__(
        ...
        self.hypergraph_encoder = HypergraphEncoderTransformer(
            hidden_dim=hidden_dim,
...
ModelPrototype = ModelPrototypeV15T
