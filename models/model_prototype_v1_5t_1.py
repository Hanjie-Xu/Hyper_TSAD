...
class ModelPrototypeV15T1(nn.Module):
    """Model v1.5t.1: causal-conv temporal encoder + hypergraph transformer, no outer residual."""
...
ModelPrototype = ModelPrototypeV15T1
